...
public class ObjectFactory {
    ...
    private final static QName _GetAllEventsResponseReturn_QNAME = new QName("http://monopoly", "return");
    private final static QName _GameDetailsResultStatus_QNAME = new QName("http://results.monopoly/xsd", "status");
    private final static QName _GetGameDetailsGameName_QNAME = new QName("http://monopoly", "gameName");
    ...
    public JAXBElement<EventArrayResult> createGetAllEventsResponseReturn(EventArrayResult value) {
        return new JAXBElement<EventArrayResult>(_GetAllEventsResponseReturn_QNAME, EventArrayResult.class, GetAllEventsResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetGameBoardSchemaResponseReturn(String value) {
        return new JAXBElement<String>(_GetAllEventsResponseReturn_QNAME, String.class, GetGameBoardSchemaResponse.class, value);
    }
    ...
    public JAXBElement<MonopolyResult> createBuyResponseReturn(MonopolyResult value) {
        return new JAXBElement<MonopolyResult>(_GetAllEventsResponseReturn_QNAME, MonopolyResult.class, BuyResponse.class, value);
    }
    ...
    public JAXBElement<MonopolyResult> createResignResponseReturn(MonopolyResult value) {
        return new JAXBElement<MonopolyResult>(_GetAllEventsResponseReturn_QNAME, MonopolyResult.class, ResignResponse.class, value);
    }
    ...
    public JAXBElement<IDResult> createJoinGameResponseReturn(IDResult value) {
        return new JAXBElement<IDResult>(_GetAllEventsResponseReturn_QNAME, IDResult.class, JoinGameResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetGameDetailsGameName(String value) {
        return new JAXBElement<String>(_GetGameDetailsGameName_QNAME, String.class, GetGameDetails.class, value);
    }
    ...
    public JAXBElement<PlayerDetailsResult> createGetPlayersDetailsResponseReturn(PlayerDetailsResult value) {
        return new JAXBElement<PlayerDetailsResult>(_GetAllEventsResponseReturn_QNAME, PlayerDetailsResult.class, GetPlayersDetailsResponse.class, value);
    }
    ...
    public JAXBElement<MonopolyResult> createSetDiceRollResultsResponseReturn(MonopolyResult value) {
        return new JAXBElement<MonopolyResult>(_GetAllEventsResponseReturn_QNAME, MonopolyResult.class, SetDiceRollResultsResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetPlayersDetailsGameName(String value) {
        return new JAXBElement<String>(_GetGameDetailsGameName_QNAME, String.class, GetPlayersDetails.class, value);
    }
    ...
    public JAXBElement<String> createJoinGameGameName(String value) {
        return new JAXBElement<String>(_GetGameDetailsGameName_QNAME, String.class, JoinGame.class, value);
    }
    ...
    public JAXBElement<MonopolyResult> createStartGameResponseReturn(MonopolyResult value) {
        return new JAXBElement<MonopolyResult>(_GetAllEventsResponseReturn_QNAME, MonopolyResult.class, StartGameResponse.class, value);
    }
    ...
    public JAXBElement<GameDetailsResult> createGetGameDetailsResponseReturn(GameDetailsResult value) {
        return new JAXBElement<GameDetailsResult>(_GetAllEventsResponseReturn_QNAME, GameDetailsResult.class, GetGameDetailsResponse.class, value);
    }
    ...
    public JAXBElement<String> createStartGameGameName(String value) {
        return new JAXBElement<String>(_GetGameDetailsGameName_QNAME, String.class, StartGame.class, value);
    }
    ...
    public JAXBElement<String> createGetGameBoardXMLResponseReturn(String value) {
        return new JAXBElement<String>(_GetAllEventsResponseReturn_QNAME, String.class, GetGameBoardXMLResponse.class, value);
    }
