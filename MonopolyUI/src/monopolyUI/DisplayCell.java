...
public class DisplayCell extends JPanel {
	 ...
	 * @param p
	 */
	public void SetOwner(PlayerDetails p)
	{
		String ownerStr;
		if (p == null)
		{
	...
	public void AddPlayerToPlayersList(PlayerDetails p)
	{
		internalAddPlayer(p, playersBox);
	}

	public void AddPlayerToSecondaryPlayersList(PlayerDetails p)
	{
		internalAddPlayer(p, secondaryPlayersBox);
	}

	private void internalAddPlayer(PlayerDetails p, Box box)
	{
	...
	public void RemovePlayerFromPlayersList(PlayerDetails p)
	{
		internalRemovePlayer(p, playersBox);
	}

	public void RemovePlayerFromSecondaryPlayersList(PlayerDetails p)
	{
		internalRemovePlayer(p, secondaryPlayersBox);
	}

	private void internalRemovePlayer(PlayerDetails p, Box box)
	{
            if (box == null)
                return;
